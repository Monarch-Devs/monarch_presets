...
-- Firetowers
{
    ...
    points = {
        ...
        vec3(2169.264, 5084.21, 44.63),
        vec3(1446.93, 2018.17, 119.43),
        vec3(-396.01, 4710.66, 263.24),
        vec3(-561.60, 4176.47, 191.64),
        vec3(-1617.84, 4557.37, 42.68),
        vec3(2865.27, 5944.88, 357.29),
        vec3(-304.26, 1378.13, 347.72),
        vec3(110.23, 6711.72, 40.67),
        vec3(2964.26, 2499.39, 164.09),
        vec3(1673.89, 3820.79, 33.96),
        vec3(2203.78, 591.71, 261.59),
        vec3(-463.75, 2036.02, 216.83),
    },
    sprite = 767,
    color = 1,
    scale = 0.8,
